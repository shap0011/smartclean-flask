...
@smartclean.route('/about')
def about():
    return render_template("about.html")

@smartclean.route('/clean', methods=["GET", "POST"])
def clean():
    alert = ""
    df_info = [] 
    df_head = ""
...
@smartclean.route('/clean_numeric_columns', methods=["POST"])
...
@smartclean.route('/clean_date_column', methods=["POST"])
...
@smartclean.route('/download_cleaned_data')
...
if __name__ == "__main__":
    smartclean.run(debug=True) # allow do not rerun the server every change